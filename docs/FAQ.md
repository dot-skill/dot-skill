...
An open format for **portable AI skills**: typed inputs, workflow, pinned knowledge, redacted journey provenance, optional token usage, integrity digests, and mint attestation. Spoken: *dot skill*. Repo: **dot-skill**.
