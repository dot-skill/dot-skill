...
Reference CLI: `skillerr` @ **0.9.10**, 165 tests passing on every push (mac/Linux/Windows × Node 22/24), including an [adversarial security corpus](https://github.com/dot-skill/skillerr/blob/main/docs/THREAT-MODEL.md) and a live-tested [transparency-log integration](https://github.com/dot-skill/skillerr/blob/main/docs/TRANSPARENCY.md).  
Independent conforming implementations welcome.

**Why the format doesn't lock you in:**

- The container is protocol-defined, not tied to this CLI — any conforming implementation can read/write it (see [docs/rfcs/](https://github.com/dot-skill/skillerr/blob/main/docs/rfcs/) for how the spec evolves in the open)
...
- [FAQ](https://github.com/dot-skill/skillerr/blob/main/docs/FAQ.md) · [Roadmap](https://github.com/dot-skill/skillerr/blob/main/docs/ROADMAP.md) · [Naming](https://github.com/dot-skill/skillerr/blob/main/docs/NAMING.md)
